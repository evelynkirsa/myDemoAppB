...
def testar_script_appium_inspector():
    ...
    caps["appium:deviceName"] = "Samsung Galaxy S9 FHD GoogleAPI Emulator" # emulador no saucelabs
    ...
    driver = webdriver.Remote("https://oauth-kirsanoffevelyn-5e329:c8031011-c25e-4117-9dd2-ce2928a10bde@ondemand.us-west-1.saucelabs.com:443/wd/hub", caps)
